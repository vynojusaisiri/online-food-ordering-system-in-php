...
if(isset($_POST['submit'] )) //if submit btn is pressed
{
	...
	mysqli_query($db, $mql);
		$success = "Account Created successfully! <p>You will be redirected in <span id='counter'>5</span> second(s).</p>
		 ...
		 header("refresh:5;url=signin.php"); // redireted once inserted success
    }
	}
                  ...
                  <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                     <ul class="nav navbar-nav">
						...
						if(empty($_SESSION["user_id"]))
							{
								echo '<li class="nav-item"><a href="signin.php" class="nav-link active">login</a> </li>
         ...
         <div class="page-wrapper">
            ...
            <section class="contact-page inner-page">
               <div class="container">
                  <div class="row">
                     <!-- REGISTER -->
                     <h3>welcome to marketer's register page</h3>
                     <div class="col-md-8">
                        <div class="widget">
                     ...
                     <div class="col-md-4">
                        ...
                        <p>Once you"re registered as marketer, you can share these landing pages to potential customers and can earn commission</p>
                        <hr>
                        <img src="http://placehold.it/400x300" alt="" class="img-fluid">
                        <p></p>
                        <h3>Can't able to register??</h3>
